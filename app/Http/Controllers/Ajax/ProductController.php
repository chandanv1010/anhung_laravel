            ...
            $html .= '<div class="uk-grid uk-grid-medium">';
                foreach($products as  $product){
                    ...
                    $html .= '<div class="uk-width-large-1-4 mb20">';
                        ...
                        $html .= "<a href='{$canonical}' class='image img-scaledown'><img src='{$image}' alt='{$name}'></a>";
                        $html .= '<div class="info">';
                        $html .= "<div class='category-name'>{$catName}</div>";
                        if ($price['percent'] && $price['percent'] > 0) {
                            $html .= "<div class='badge-sale'>Sale</div>";
                        }
                        ...
                        $html .= "<a href='{$canonical}' title='{$name}'>Xem chi tiết</a>";
                        $html .= '</div>';
                        $html .= '</div>';
                        $html .= '</div>';
