...
@php
    $coreCss = [
        ...
        'mobile/resources/fonts/font-awesome-4.7.0/css/font-awesome.min.css',
        'mobile/resources/uikit/css/uikit.modify.css',
        'mobile/resources/library/css/library.css',
...
@endforeach
<script src="{{ asset('mobile/resources/library/js/jquery.js') }}"></script>